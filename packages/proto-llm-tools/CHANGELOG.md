...
- 64668b6: Internal refinements to deep-agent-entity-researcher bundle validation

## 0.1.5

### Patch Changes

- e8b671f: Upgraded Tiptap dependencies from v2.10.4 to v3.10.5

  Updated dependencies:
  - @tiptap/core: ^2.10.4 → ^3.10.5
  - @tiptap/react: ^2.10.4 → ^3.10.5
  - @tiptap/starter-kit: ^2.10.4 → ^3.10.5
